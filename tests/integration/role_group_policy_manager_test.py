...
class RoleGroupPolicyManagerTest(IntegrationSetup):
    ...
    def test_add_role_adds_role_to_policy(self):
        self.role_group_policy_manager.add_role(self.role_group.get_uuid(), self.role.get_uuid())
        role_group_policy = self.role_group_policy_manager.get_role_group_policy(self.role_group.get_uuid())
    ...
    def test_add_role_adds_multiple_roles(self):
        ...
        self.role_group_policy_manager.add_role(self.role_group.get_uuid(), self.role.get_uuid())
        self.role_group_policy_manager.add_role(self.role_group.get_uuid(), new_role.get_uuid())
        role_group_policy = self.role_group_policy_manager.get_role_group_policy(self.role_group.get_uuid())
        role_policies = role_group_policy.get_role_policies()
    ...
    def test_add_action_adds_action_to_policy_role(self):
        role_group_role = self.role_group_policy_manager.add_role(self.role_group.get_uuid(), self.role.get_uuid())
        self.role_group_policy_manager.add_action(role_group_role.get_uuid(), self.action.get_uuid())
        role_policy_group = self.role_group_policy_manager.get_role_group_policy(self.role_group.get_uuid())
    ...
    def test_add_action_adds_multiple_actions_on_different_roles(self):
        ...
        first_rp = self.role_group_policy_manager.add_role(self.role_group.get_uuid(), roles[0].get_uuid())
        second_rp = self.role_group_policy_manager.add_role(self.role_group.get_uuid(), roles[1].get_uuid())
        self.role_group_policy_manager.add_action(first_rp.get_uuid(), actions[0].get_uuid())
        self.role_group_policy_manager.add_action(second_rp.get_uuid(), actions[1].get_uuid())
        role_group_policy = self.role_group_policy_manager.get_role_group_policy(self.role_group.get_uuid())
        role_policies = role_group_policy.get_role_policies()
    ...
    def test_delete_role_deletes_role_from_group_policy(self):
        role_group_role = self.role_group_policy_manager.add_role(self.role_group.get_uuid(), self.role.get_uuid())
        self.role_group_policy_manager.add_role(self.role_group.get_uuid(), self.role_manager.create(
            "BASIC",
            "Basic role"
        ).get_uuid())
        self.role_group_policy_manager.delete_role(role_group_role.get_uuid())
        role_group_policy = self.role_group_policy_manager.get_role_group_policy(self.role_group.get_uuid())
    ...
    def test_delete_role_fails_on_invalid_role_group_role(self):
        with self.assertRaises(RoleGroupPolicyDeleteRoleException):
            self.role_group_policy_manager.delete_role("sdfsdf")
    ...
    def test_delete_action_deletes_action_from_role_policy(self):
        role_group_role = self.role_group_policy_manager.add_role(self.role_group.get_uuid(), self.role.get_uuid())
        role_group_role_action = self.role_group_policy_manager.add_action(
            role_group_role.get_uuid(),
            self.action.get_uuid()
        )
        self.role_group_policy_manager.delete_action(role_group_role_action.get_uuid())
        role_group_policy = self.role_group_policy_manager.get_role_group_policy(self.role_group.get_uuid())
    ...
    def test_delete_action_fails_on_invalid_role_group_role_action(self):
        with self.assertRaises(RoleGroupPolicyDeleteActionException):
            self.role_group_policy_manager.delete_action("sdfsdf")
    ...
    def test_get_role_group_policy_fails_on_empty_role_group_policy(self):
        with self.assertRaises(RoleGroupPolicyFetchException):
            self.role_group_policy_manager.get_role_group_policy("123-123")
